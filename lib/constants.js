...
const DATAFIELDS = [
    ...
    {
        id: 'indoortemp_timestamp',
        channels: [{
            channel: 'weather.maxvalues.daily',
            name: 'Max. Indoor temperature (timestamp)'
        },{
            channel: 'weather.minvalues.daily',
            name: 'Min. Indoor temperature (timestamp)'
        }],
        type: 'string',
        role: 'value.time',
        wunderground: '',
        ecowitt: '',
        scheduler: 'indoortemp_timestamp',
        listener_conversion: null,
        scheduler_conversion: 'parseInt(x.toString(16).substring(0,1), 16) + ":" + parseInt(x.toString(16).substring(1), 16)' ,
    },
    {
        id: 'monthlyrain',
        channels: [{
...
const COMMANDS = [
    ...
    },
    {
        ...
        parser: new BinaryParser()
            .endianess('big').seek(7)
            .int16('indoortemp')
            .int16('indoortemp_timestamp').seek(1)
            .int16('outdoortemp')
