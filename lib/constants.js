// Removed unused imports: `subscribe` and `write`
...
const DATAFIELDS = [
    ...
    },
    {
        ...
        min: 0,
        max: 100,
        wunderground: '^humidity([0-9][0-9])*',
        ecowitt: '^humidity([0-9][0-9])*',
...
const COMMANDS = [
    {
        name: 'Return Header',
        configurable: false,
        parser: new BinaryParser().endianess('big').seek(2).uint8('command').seek(2).uint8('subcommand'),
    },

    {
        ...
        command_int: 80,
        subcommand_int: 69,
        parser: new BinaryParser().endianess('big').seek(5).string('softwaretype', {
            encoding: 'utf8',
            length: 17,
        }),
    },
    ...
    },
    {
        ...
        parser: new BinaryParser()
            ...
            .seek(7)
            .int16('indoortemp')
            .int16('indoortemp_time')
            .seek(1)
            .int16('outdoortemp')
            .int16('outdoortemp_time')
            .seek(1)
            .int16('dewpointtemp')
            .int16('dewpointtemp_time')
            .seek(1)
            .int16('windchilltemp')
            .int16('windchilltemp_time')
            .seek(1)
            .uint8('indoorhumidity')
            .int16('indoorhumidity_time')
            .seek(1)
            .uint8('outdoorhumidity')
            .int16('outdoorhumidity_time')
            .seek(1)
            .uint16('pressureabs')
            .int16('pressureabs_time')
            .seek(1)
            .uint16('pressurerel')
            .int16('pressurerel_time')
            .seek(1)
            .uint16('windspeed')
            .int16('windspeed_time')
            .seek(1)
            .uint16('windgustspeed')
            .int16('windgustspeed_time')
            .seek(1)
            .uint32('dailyrain')
            .int16('dailyrain_time')
            .seek(1)
            .uint32('solarradiation')
            .int16('solarradiation_time')
            .seek(1)
            .uint16('UVraw')
            .int16('UVraw_time')
            .seek(1)
