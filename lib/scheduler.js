...
class Scheduler {
    ...
    setDecimals(objData) {
        ...
        if (objData.solarradiation)
            objData.solarradiation = (objData.solarradiation / 10000).toFixed(0);
        if (objData.solarradiatiomax)
            objData.solarradiatiomax = (objData.solarradiatiomax / 10000).toFixed(0);
        if (objData.solarradiationdailymax)
            objData.solarradiationdailymax = (objData.solarradiationdailymax / 10000).toFixed(0);
