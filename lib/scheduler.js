...
class Scheduler {
    ...
    setDecimals(objData) {
        ...
        const divide_by_10000 = ['UVraw', 'UVrawmax', 'UVdailymax'];
        for (const state of divide_by_10000) {
            if (objData[state]) {
                objData[state] = objData[state] / 10000;
            }
        }
