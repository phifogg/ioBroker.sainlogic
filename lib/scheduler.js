...
class Scheduler {
    ...
    setDecimals(objData) {
        const divide_by_10 = ['indoortemp', 'temp', 'dewpt', 'windchill', 'barom',
            'absbarom', 'rain', 'dailyrain', 'weeklyrain', 'monthlyrain', 'yearlyrain','solarradiation','UVraw',
            // abs max values
            'indoortempmax', 'tempmax', 'dewptmax', 'windchillmax', 'barommax',
            'absbarommax', 'rainmax', 'dailyrainmax', 'weeklyrainmax', 'monthlyrainmax',
            'yearlyrainmax', 'solarradiationmax', 'UVrawmax',
            // abs min values
            ...
            'absbaromdailymax', 'raindailymax', 'solarradiationdailymax','UVrawdailymax',
            // daily min values
